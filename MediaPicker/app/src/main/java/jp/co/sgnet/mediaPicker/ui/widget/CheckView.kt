...
class CheckView: View {
    ...
    private fun initParams(context: Context?) {
        ...
        mCheckDrawable = ResourcesCompat.getDrawable(context.resources, android.R.drawable.checkbox_on_background, context.theme)
    }
    ...
    private fun initShadowPaint() {
        if (mShadowPaint == null) {
            ...
            val shadow = ContextCompat.getColor(context, R.color.abc_btn_colored_borderless_text_material)
            val shadowHint = ContextCompat.getColor(context, R.color.design_bottom_navigation_shadow_color)
